...
class Component {
  ...
  @override
  String toString() {
    return 'Component(id: $id, name: $name, importance: $importance, isInternal: $isInternal, description: $description, attributes: $attributes, enabled: $enabled)';
  }
  ...
  @override
  int get hashCode {
    return id.hashCode ^ name.hashCode ^ importance.hashCode ^ isInternal.hashCode ^ description.hashCode ^ attributes.hashCode ^ enabled.hashCode;
  }
}
